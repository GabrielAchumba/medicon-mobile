...
class ModalBvnVerifiedFourScreen extends StatelessWidget {
  const ModalBvnVerifiedFourScreen({Key? key})
      : super(
          key: key,
        );
          ...
          child: Column(
            children: [
              ...
              Container(
                ...
                child: Text(
                  "Your account has been successfully confirmed, proceed to sign in.",
                  maxLines: 2,
