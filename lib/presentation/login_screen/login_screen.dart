...
class LoginScreen extends StatelessWidget {LoginScreen({Key? key}) : super(key: key);
  ...
  /// Section Widget
  Widget _buildInputPasswordEditText(BuildContext context) { return CustomTextFormField(controller: inputPasswordEditTextController, textInputAction: TextInputAction.done, suffix: Container(margin: EdgeInsets.fromLTRB(30.h, 16.v, 16.h, 16.v), child: CustomImageView(imagePath: ImageConstant.imgEyeoff, height: 24.adaptSize, width: 24.adaptSize)), suffixConstraints: BoxConstraints(maxHeight: 56.v), obscureText: true); } 
  /// Section Widget
  Widget _buildRememberRow(BuildContext context) { 
      return Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, 
        crossAxisAlignment: CrossAxisAlignment.start, 
        children: [CustomCheckboxButton(
          text: "Remember me", 
          value: rememberMe, 
  ...
  /// Navigates to the frame1184Screen when the action is triggered.
  onTapTxtForgotPassword(BuildContext context) { Navigator.pushNamed(context, AppRoutes.frame1184Screen); } 
