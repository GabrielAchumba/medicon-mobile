...
class CreateANewAccountTwoScreen extends StatelessWidget {CreateANewAccountTwoScreen({Key? key}) : super(key: key);
...
/// Section Widget
Widget _buildFirstName(BuildContext context) { return CustomTextFormField(controller: firstNameController, hintText: "First Name", hintStyle: CustomTextStyles.titleSmallOnError, contentPadding: EdgeInsets.symmetric(horizontal: 16.h, vertical: 19.v), borderDecoration: TextFormFieldStyleHelper.fillGrayTL8); } 
/// Section Widget
Widget _buildLastName(BuildContext context) { return CustomTextFormField(controller: lastNameController, hintText: "Last Name", hintStyle: CustomTextStyles.titleSmallOnError, contentPadding: EdgeInsets.symmetric(horizontal: 16.h, vertical: 19.v), borderDecoration: TextFormFieldStyleHelper.fillGrayTL8); } 
/// Section Widget
Widget _buildDateOfBirth(BuildContext context) { return CustomTextFormField(controller: dateOfBirthController, hintText: "Date of Birth", hintStyle: CustomTextStyles.titleSmallOnError, suffix: Container(margin: EdgeInsets.fromLTRB(30.h, 17.v, 16.h, 17.v), child: CustomImageView(imagePath: ImageConstant.imgCalendarDateRangeOnerror, height: 22.adaptSize, width: 22.adaptSize)), suffixConstraints: BoxConstraints(maxHeight: 56.v), borderDecoration: TextFormFieldStyleHelper.fillGrayTL8); } 
/// Section Widget
Widget _buildEmail(BuildContext context) { return CustomTextFormField(controller: emailController, hintText: "Email Address", hintStyle: CustomTextStyles.titleSmallOnError, textInputType: TextInputType.emailAddress, contentPadding: EdgeInsets.symmetric(horizontal: 16.h, vertical: 19.v)); } 
/// Section Widget
Widget _buildPassword(BuildContext context) { return CustomTextFormField(controller: passwordController, hintText: "Password", hintStyle: CustomTextStyles.titleSmallOnError, textInputType: TextInputType.visiblePassword, suffix: Container(margin: EdgeInsets.fromLTRB(30.h, 17.v, 17.h, 17.v), child: CustomImageView(imagePath: ImageConstant.imgEyeoff, height: 22.adaptSize, width: 22.adaptSize)), suffixConstraints: BoxConstraints(maxHeight: 56.v), obscureText: true, borderDecoration: TextFormFieldStyleHelper.fillGrayTL8); } 
/// Section Widget
...
/// Section Widget
Widget _buildChecklist(BuildContext context) { return Align(alignment: Alignment.centerLeft, child: Padding(padding: EdgeInsets.only(right: 47.h), child: CustomCheckboxButton(alignment: Alignment.centerLeft, text: "By creating an account, you agree to our?  User Agreement and Terms & Conditions", isExpandedText: true, value: checklist, textStyle: CustomTextStyles.bodyMediumAeonikOnError, onChange: (value) {checklist = value;}))); } 
/// Section Widget
Widget _buildCreateNewAccount(BuildContext context) { return CustomElevatedButton(text: "Create new account", buttonTextStyle: theme.textTheme.titleSmall!, onPressed: () {onTapCreateNewAccount(context);}); } 
/// Navigates to the createANewAccountScreen when the action is triggered.
onTapCreateNewAccount(BuildContext context) { Navigator.pushNamed(context, AppRoutes.createANewAccountScreen); } 
