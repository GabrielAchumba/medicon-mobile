import '../missed_appointments_page/widgets/userprofile2_item_widget.dart';
import 'package:flutter/material.dart';
import 'package:medicon/core/app_export.dart';
import 'package:medicon/widgets/custom_text_form_field.dart';

class MissedAppointmentsPage extends StatefulWidget {const MissedAppointmentsPage({Key? key}) : super(key: key);

@override MissedAppointmentsPageState createState() =>  MissedAppointmentsPageState();

 }

// ignore_for_file: must_be_immutable
class MissedAppointmentsPageState extends State<MissedAppointmentsPage> with  AutomaticKeepAliveClientMixin<MissedAppointmentsPage> {TextEditingController monthEditTextController = TextEditingController();
