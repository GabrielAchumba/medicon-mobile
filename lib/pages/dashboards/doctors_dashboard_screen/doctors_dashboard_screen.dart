...
class DoctorsDashboardScreen extends StatefulWidget {
  DoctorsDashboardScreen({Key? key}) : super(key: key);

  @override
  State<DoctorsDashboardScreen> createState() => _DoctorsDashboardScreenState();
}

class _DoctorsDashboardScreenState extends State<DoctorsDashboardScreen> {
int sliderIndex = 1;
