...
class MedicalRegistrationScreen extends StatefulWidget {
  ...
  const MedicalRegistrationScreen(this.groupName,
  {super.key});
...
class _MedicalRegistrationScreenState extends State<MedicalRegistrationScreen> {
  ...
  Widget build(BuildContext context) {
    _context = context;
    return Consumer<FileStorageServices>(builder: (ctx, medicalRegistrationVM, child) {
      return SafeArea(
        child: Scaffold(
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Text(
                    "Upload certificate of full medical registration.",
                    maxLines: 2,
                ...
                CustomElevatedButton(
                  ...
                  busy: medicalRegistrationVM.isLoading,
                  onPressed: () async {
                    FilePayload filePayload = await medicalRegistrationVM.UploadFileOneByOneToGCP(
                        context: ctx,
