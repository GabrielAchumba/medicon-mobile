...
class SpecialtyCertificateScreen  extends StatefulWidget {
 ...
 const SpecialtyCertificateScreen(this.groupName,
  ...
  @override
  State<SpecialtyCertificateScreen> createState() => _SpecialtyCertificateScreenState();
}
...
class _SpecialtyCertificateScreenState extends State<SpecialtyCertificateScreen> {
  ...
  Widget build(BuildContext context) {
    _context = context;
    return Consumer<FileStorageServices>(builder: (ctx, specialCertificateVM, child) {
      return SafeArea(
        child: Scaffold(
          appBar: _buildAppBar(),
          body: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                CustomElevatedButton(
                  text: "Submit",
                  busy: specialCertificateVM.isLoading,
                  onPressed: () async {
                  FilePayload filePayload = await specialCertificateVM.UploadFileOneByOneToGCP(
                    context: ctx,
