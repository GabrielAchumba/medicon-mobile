...
class CurrentYearLicenseScreen extends StatefulWidget {

  final String groupName;

  const CurrentYearLicenseScreen(this.groupName,
  {super.key});

  @override
  State<CurrentYearLicenseScreen> createState() => _CurrentYearLicenseScreenState();
}

class _CurrentYearLicenseScreenState extends State<CurrentYearLicenseScreen> {
  ...
  Widget build(BuildContext context) {
    _context = context;
    return Consumer<FileStorageServices>(builder: (ctx, currentYearLicenseVM, child) {
      return SafeArea(
        child: Scaffold(
            ...
            child: Column(
              ...
              children: [
                ...
                CustomElevatedButton(
                  ...
                  busy: currentYearLicenseVM.isLoading,
                  onPressed: () async {
                    FilePayload filePayload = await currentYearLicenseVM.UploadFileOneByOneToGCP(
                        context: ctx,
